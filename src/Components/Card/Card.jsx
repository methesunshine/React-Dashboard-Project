...
const Card = ({ data }) => {
  ...
  // Format the numeric amount if it's "Total Sales", "Total Expenses", or "Total Visitors"
  const numericAmount =
    title === 'Total Sales' || title === 'Total Expenses' || title === 'Total Visitors'
      ? parseFloat(amount.replace(/[$,]/g, ''))
      : amount;

  // Check if the amount should display the dollar sign
